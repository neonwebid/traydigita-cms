...
namespace ArrayAccess\TrayDigita\App\Middlewares;

use ArrayAccess\TrayDigita\App\Modules\Users\Route\Attributes\Dashboard;
 ...
 */
class InitMiddlewares extends AbstractMiddleware
{
   /**
